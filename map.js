var yearDropdown = document.getElementById('census-year-dropdown');
var varDropdown = document.getElementById('census-variable-dropdown');
...
var map = new maplibregl.Map({
  container: 'map-l',
  style: 'https://api.maptiler.com/maps/pastel/style.json?key=fXc4knA6xdFWVhZVbmqa',
  center: [-79.55, 43.67],
  zoom: 10,
});
...
map.on('load', function () {
  ...
  // Fit Etobicoke
  map.fitBounds( etobicokeBounds, { padding: 10 } )
